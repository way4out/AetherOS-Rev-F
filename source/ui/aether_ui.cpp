...
static void module(const SystemState&s){
    ...
    case MOD_NETWORK: iprintf("NETWORK FABRIC\nWIFI %s\n5G EXTERNAL GATEWAY\nSAT EXTERNAL GATEWAY\nBT EXTERNAL GATEWAY\nSDR EXTERNAL GATEWAY\nQPU EXTERNAL GATEWAY\nAUTHORIZED HARDWARE ONLY",heritage::enabled(heritage::OEQL_PROTOCOL)?"READY":"OFF",heritage::enabled(heritage::STELLARPHONE_BRIDGE)?"READY":"OFF",s.networkReady?"LINK":"OFF");break;
