...
void init(){r.protocol=protocol::selfTest();r.storage=hardware::sdAvailable();r.quantum=true;r.audio=true;r.gateways=false;r.score=(r.protocol?25:0)+(r.storage?25:0)+25+25;t=0;}
