...
OBJECTS := $(BUILD)/main.o $(BUILD)/aether_core.o $(BUILD)/hardware_profile.o $(BUILD)/benchmark.o $(BUILD)/aether_ui.o $(BUILD)/quantum_core.o $(BUILD)/engine_modules.o $(BUILD)/aether_audio.o $(BUILD)/network_fabric.o $(BUILD)/radio_gateway.o $(BUILD)/remote_compute.o $(BUILD)/gateway_protocol.o $(BUILD)/gateway_session.o $(BUILD)/gateway_security.o $(BUILD)/wifi_transport.o $(BUILD)/gateway_client.o $(BUILD)/system_graph.o $(BUILD)/recovery.o $(BUILD)/governor.o
